            ...
            <div className="flex bg-base-200 min-h-screen">
                ...
                <div className="flex-1 md:ml-64">
                    ...
                    <div className="max-w-3xl mx-auto p-4 sm:p-6">
                        ...
                        <div className="mb-6">
                            <h1 className="text-3xl font-bold text-base-content">Edit Entry</h1>
                            <p className="text-base-content/70 text-sm mt-1">Update your reflection.</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                            ...
                            <div className="relative w-full h-56 sm:h-72 rounded-2xl overflow-hidden bg-base-100 border-2 border-dashed border-primary/30">
                                {existingImages[0]?.url ? (
                                    ...
                                    <label className="w-full h-full flex flex-col items-center justify-center cursor-pointer">
                                        ...
                                        <p className="font-medium text-base-content">Add a cover image</p>
                                        <p className="text-xs text-base-content/60 mt-1">Click to upload or drag and drop</p>
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                ...
                                <div className="bg-base-100 border border-base-300 rounded-xl p-4">
                                    <p className="text-sm font-semibold text-base-content mb-1">Tags</p>
                                    <p className="text-xs text-base-content/60 mb-3">Add relevant tags</p>
                                ...
                                {/* Mood */}
                                <div className="bg-base-100 border border-base-300 rounded-xl p-4">
                                    <p className="text-sm font-semibold text-base-content mb-1">Mood</p>
                                    <p className="text-xs text-base-content/60 mb-3">How are you feeling?</p>
                                    <MoodSelect mood={mood} setMood={setMood} />
                                </div>

                                {/* Visibility */}
                                <div className="bg-base-100 border border-base-300 rounded-xl p-4">
                                    <p className="text-sm font-semibold text-base-content mb-1">Visibility</p>
                                    <p className="text-xs text-base-content/60 mb-3">Who can view this entry?</p>
                                    <div className="flex flex-col gap-2">
                                        ...
                                        >
                                            ...
                                            <div>
                                                <p className="text-sm font-medium text-base-content">Community</p>
                                                <p className="text-xs text-base-content/60">Share with the community</p>
                                            </div>
                                        </button>
                                    </div>
                                </div>
